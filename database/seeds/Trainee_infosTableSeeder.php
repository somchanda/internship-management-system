...
class Trainee_infosTableSeeder extends Seeder
{
    ...
    public function run()
    {
        $position = array('PHP Intern', 'Java Intern', 'C# Intern', 'C++ Intern', 'Python Intern', 'ASP.NET Intern');
        $start_date = array('2020-02-01', '2020-01-01', '2020-03-01', '2020-04-01', '2020-05-01', '2020-06-01');
        $end_date = array('2020-04-30', '2020-03-31', '2020-05-31', '2020-06-30', '2020-07-31', '2020-08-31');
        $status = array('Doing Internship', 'Fail', 'Stop', 'Continue');
        ...
        for ($i = 3; $i <= 17; $i++) {
            ...
            DB::table('trainee_infos')->insert([
                ...
                'internship_status' => $status[array_rand($status, 1)],
